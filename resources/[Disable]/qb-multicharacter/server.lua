...
-- custom_auth owns the /logout command (account-based flow) when it is running.
if GetResourceState('custom_auth') ~= 'started' and GetResourceState('custom_auth') ~= 'starting' then
